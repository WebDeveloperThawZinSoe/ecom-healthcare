...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post("/videos",[GeneralSettingController::class, 'VideoStore'])->name("video.store");
    ...
    Route::put('/delivery/update/{delivery}', [AdminDeliveryController::class, 'update'])->name('delivery.update');
