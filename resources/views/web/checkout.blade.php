@extends('web.master')
@section('body')
<!-- jQuery (Make sure only one version is loaded) -->
...
<div class="page-content">
    ...
    $(document).ready(function() {
        ...
        console.log('Select2 version:', $.fn.select2 ? $.fn.select2.defaults : 'Not loaded');
            ...
            console.error('Select2 failed to load');
                        ...
                        <div class="col-md-12">
                            <div class="m-b25">
                                ...
                                <select name="country" class="default-select2 w-100">
