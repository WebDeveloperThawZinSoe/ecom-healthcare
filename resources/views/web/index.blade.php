...
<div class="page-content bg-white">
    @php
    $photos = App\Models\Gallery::where("type","banner")->orderBy("sort","desc")->get();
    //$photo = $photos->image;
    @endphp
    ...
    <!-- Video Section -->
    @php 
        $videos = App\Models\Gallery::where("type", "video")->orderBy("sort", "desc")->get();
    @endphp
    
    @if($videos->count() > 0)
<section class="content-inner">
    <div class="container">
        <h2 class="text-center">Our Product Videos</h2>
        <br>
        <div class="row justify-content-center">
            @if($videos->count() == 1 || $videos->count() == 2)
                ...
                @endforeach
            @elseif($videos->count() == 3)
                <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                    <div class="video-container">
                        <video class="w-100 rounded" controls>
                            <source src="{{ asset($videos[0]->image) }}" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                    <div class="video-container">
                        <video class="w-100 rounded" controls>
                            <source src="{{ asset($videos[1]->image) }}" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                    <div class="video-container">
                        <video class="w-100 rounded" controls>
                            <source src="{{ asset($videos[2]->image) }}" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                    </div>
                </div>
...
@endif
    ...
    <section class="content-inner">
        <div class="container">
            <h2>Some Brands On Our Platform</h2>
            <br>
            <div class="row">
